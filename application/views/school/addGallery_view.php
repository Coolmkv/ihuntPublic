                        ...
                        <div class="my-panel-body">
                            <div class="list-unstyled row clearfix masonry-container lightgallery"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 item video">
                                    ...
                                    <?php echo form_open_multipart('school/addNewGalleryImage', ["id" => "galary_form", "role" => "form", "name" => "galary_form", "data-toggle" => "validator"]); ?>
                                    <fieldset>
                                        <div>
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-white btn-file">
                                                            ...
                                                            <input type="file" id="galaryUrl" accept="image/x-png,image/gif,image/jpeg"  name="galaryUrl" class="default"
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('school/deleteGalleryImage'); ?>',
