            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart("University/uploadProfileImage", ["name" => "logo_form", "class" => "form-horizontal", "id" => "logo_form"]) ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                                        <label class="control-label">Upload Logo:</label>
                                        <input type="file" accept="image/x-png,image/gif,image/jpeg" name="orgLogo" id="orgLogo" class="form-control" required="true" onchange="uploadFile()"><br>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('University/uploadHeaderImage', ["name" => "header_form"]); ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    <label>Logo</label>
                                    <img  style="height:210px;width: 300px" alt="No selected Logo"src="<?php
                                    if ($orgLogo == '') {
                                        echo $orgLogo;
                                        ?><?php
                                    } else {
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img  style="height:210px;width: 300px" alt="No selected Header Image" src="<?php
                                    if ($orgImgHeader == '') {
                                        echo $orgImgHeader;
                                        ?><?php
                                    } else {
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <br><br><br><br>
                                <a href="<?php echo site_url('university/editprofile'); ?>"><button style="margin-top:3px;width: 135px" class="form-control btn btn-primary" type="submit" name="header_submit" id="header_submit">Edit Profile</button></a>&nbsp;&nbsp;&nbsp;
                                <a href="<?php echo site_url('university/addCourse'); ?>"> <button style="margin-top:3px;width: 135px" class="form-control btn btn-primary" type="submit" name="header_submit" id="header_submit">Add Courses</button></a>
