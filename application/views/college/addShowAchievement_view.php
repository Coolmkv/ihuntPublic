        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/addAchievement', ["id" => "achieve_form", "name" => "achieve_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editAchievement", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + achiveId,
                url: "<?php echo site_url('college/getAchievement'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + achiveId,
                            url: "<?php echo site_url("college/delAchievement"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
