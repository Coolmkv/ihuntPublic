...
<?php echo form_open_multipart('university/addFaculty', ["id" => "faculty_form", "name" => "faculty_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select name="departmentId" id="departmentId" class="form-control" data-validation="required"></select>
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editFaculty", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + facultyId,
                url: "<?php echo site_url('university/getFaculty'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("university/delFaculty"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
