                                ...
                                <table id="showdata_table" class="table table-bordered table-striped table-condensed table-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Top Rated College</th>
                                            <th>Latest College</th>
                                            <th>Feature College</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("change", ".login_status", function () {
            ...
            $.ajax({
                type: "POST",
                data: {id: id, login_status: login_status, roletype: "College"},
        ...
        $(document).on('change', '.admin_approved', function () {
            ...
            $.ajax({
                type: "POST",
                data: "loginId=" + loginId + '&admin_approved=' + admin_approved + '&roleType=College',
        ...
        $(document).on('change', '.changeStatus', function () {
            ...
            $.ajax({
                type: "POST",
                data: {orgId: orgId, orgStatus: orgStatus, Statustype: Statustype, orgType: 'College', statusName: statusName},
...
<script type="text/javascript">
    $(".treeviewCd_link").addClass("active");
    $(".organicationDetails_link").addClass("active");
    document.title = "iHuntBest | College Details";
</script>