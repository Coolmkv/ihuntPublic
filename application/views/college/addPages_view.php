        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/addNewPages', ["id" => "pages_form", "name" => "pages_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editPages', function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + pageId,
                url: "<?php echo site_url('college/showPages'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + pageId,
                            url: "<?php echo site_url("college/delPages"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: "<?php echo site_url("college/submitForApproval"); ?>",
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                $.alert({
