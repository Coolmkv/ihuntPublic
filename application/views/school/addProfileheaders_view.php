            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart("school/uploadheaderImageVideo", ["name" => "imageVideo", "class" => "form-horizontal", "id" => "imageVideo"]) ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('school/uploadheaderImageVideo', ["name" => "header_video", "id" => "header_video"]); ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group videodiv">
                                    ...
                                    <div class="text-center">
                                        <button style="margin-left:5px; margin-top: 5px;width: 100px" onclick="clearForm('header_video');"  class="form-control btn btn-primary" type="submit" id="orgLogo" name="orgLogo" data-toggle="modal" data-target="#HeaderVideo">Edit Video</button>
                                    </div>
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('school/deleteHeaderImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('school/setDefaultImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
