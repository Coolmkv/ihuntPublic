		...
		<div class="row box-body">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<?php echo form_open('college/addUpdateNewCourse', ["name" => "course_form", "id" => "new_course_form"]); ?>
						<div class="row">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('college/editCourseMaster', ["name" => "editCourse", "id" => "editCourse_form"]); ?>
                        <fieldset>
...
<script type="text/javascript">
	...
	let datatable =	$('#page_table').DataTable({
        ...
        serverSide: false,
        ajax: {
			'url':'<?php echo site_url('college/getAllCourseDetails'); ?>',
			'method':'post'
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url("college/deleteCourseMasterEntry"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
