...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">  Brand Empowerment Text</li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">  Brand Empowerment Text </h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editShowBrandEmpowerment", ["id" => "submit_form"]); ?>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="editShowBrandEmpowerment();">Edit</button>
...
<script type="text/javascript">
    ...
    function editShowBrandEmpowerment() {
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getShowBrandEmpowerment'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.beText);

                    $("#bybId").val(json.beId);

                    $('#beforeYouBegin').summernote('code', json.beText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | Brand Empowerment";
