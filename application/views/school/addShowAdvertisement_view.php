        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart('school/addAdvertisement', ["id" => "advertisement_form", "name" => "advertisement_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                ...
                <div class="container-fluid nopadding">
                    <div class="row"  >
                        <div class="col-lg-12 nopadding">
                            <?php echo form_open('school/updateTime', ["id" => "startDate_form", "name" => "startDate_form"]); ?>
                            <fieldset>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".editAdvertisement", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + adsId,
                url: "<?php echo site_url('school/getAdvertisement'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("school/delAdvertisement"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
    ...
    function getLocations() {
        $.ajax({
            url: "<?php echo site_url('school/getPlandetailsJson'); ?>",
            type: 'POST',
            data: {location: "find"},
            success: function (response) {
                var json = $.parseJSON(response);
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response !== "") {
                    ...
                    for (var i = 0; i < json.length; i++) {
                        data = data + '<option value="' + json[i].planId + '"> ' + json[i].planName + '</option>';
                    }
