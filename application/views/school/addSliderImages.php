        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <?php echo form_open_multipart("school/updateSliderImage", ["name" => "updateimage_form", "class" => "form-horizontal", "id" => "updateimage_form"]) ?>
                        ...
                        <div class="my-panel-body">
                            <div class="list-unstyled row clearfix masonry-container lightgallery"
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 item video">
                                    ...
                                    <?php echo form_open_multipart('school/addSliderImage', ["id" => "image_form", "role" => "form", "name" => "image_form", "data-toggle" => "validator"]); ?>
                                    <fieldset>
                                        <div>
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('school/deleteSliderImage'); ?>',
