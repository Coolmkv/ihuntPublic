...
if($this->session->userdata('amount')){
	...
	$this->Home_model->payment_info($amount,$order_id,$razorpay_payment_id,$currency_code,$student_id,$status,$org_id,$course_id);
	
		$array_items = array('amount','order_id','razorpay_payment_id', 'currency_code','org_id', 'course_id');
