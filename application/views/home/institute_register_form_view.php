                    ...
                    <div class="col-md-12 details-text-to-3">
                        <div class="tabbable-panel margin-tops4 ">
                            <div class="tabbable-line">
                                <?php echo form_open('institute/saveProfile', ["id" => "profile_form", "name" => "profile_form"]); ?>
                                    ...
                                    <div class="tab-pane fade" id="tab_default_4">
                                        ...
                                        <div class="to-college">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-5"></div>
                                                <div class="col-md-3">
                                                    <input style="margin-top:3px" type="submit" value="SUBMIT" class="btn apply btnNext" name="save_profile" id="save_profile">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                success: function (response) {
                    ...
                    if (json.status === 'success') {
                        $.alert({title: 'Success!', content: json.msg, type: 'blue',
                            ...
                            buttons: {
                                Ok: function () {
                                    window.location = '<?php echo site_url('institute/dashboard'); ?>';
                                }
                            }
                        });
                    } else {
