            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Accepted Page Request Details</h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {pageStatusType: "approval_accepted"},
    ...
    function viewPage(pageId) {
        if (pageId !== "") {
            $.ajax({
                type: "POST",
                data: {pageId: pageId, pageStatusType: "approval_accepted"},
                url: "<?php echo site_url('superadmin/getPageRequests'); ?>",
                success: function (response) {
                    if (response !== "") {
                        var json = $.parseJSON(response);
...
<script type="text/javascript">
    ...
    $(".apageReqLink").addClass("active");
    document.title = "iHuntBest | Page Request Accepted Details";
</script>