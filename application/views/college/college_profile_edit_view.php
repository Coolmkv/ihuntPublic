        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/updateProfile', ["id" => "profile_form", "name" => "profile_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="establishdate" value="<?php echo $orgEstablished; ?>" max="<?php echo date('Y-m-d'); ?>" id="establishdate" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" placeholder="Organization Address" value="<?php echo $orgAddress; ?>" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo form_open("college/requestFacility", ["id" => "facility_form"]); ?>
                                <input type="hidden" name="id" id="id" value="no_one">
                                <fieldset>
                                    <!-- Text input-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo form_open('college/addNewOrganisationType', ["id" => "organizationTypeForm"]); ?>
                        <fieldset>
                            <!-- Text input-->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            url: "<?php echo site_url("college/getProfileData"); ?>",
            type: 'POST',
            data: '',
            success: function (response) {
                if (response) {
    ...
    function facilities_div() {
        $.ajax({
            url: '<?php echo site_url('college/orgFacilities'); ?>',
