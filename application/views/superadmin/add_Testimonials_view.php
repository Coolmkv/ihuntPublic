        ...
        <div class="row box-body">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("superadmin/editTestimonials", ["id" => "submit_form"]); ?>
                    <div class="box-body">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="file" name="userImage" id="userImage" accept="image/x-png,image/gif,image/jpeg" class="form-control" data-validation ="required">
                        </div>
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        ...
                        $.ajax({
                            type: "POST",
                            data: {testimonialId: testimonialId},
                            url: "<?php echo site_url('superadmin/delTestimonial'); ?>",
                            success: function (response) {
                                var result = $.parseJSON(response);
