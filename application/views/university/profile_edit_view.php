        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/updateProfile', ["id" => "profile_form", "name" => "profile_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="directorName" id="directorName" value="<?php echo $directorName; ?>" placeholder="Director Name" class="form-control" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Director Mobile</label>
                                    <input type="text" name="directorMobile" id="directorMobile" value="<?php echo $directorMobile; ?>" placeholder="Director Mobile" class="form-control" data-validation="number length required"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="directorEmail" id="directorEmail" value="<?php echo $directorEmail; ?>" placeholder="Director Email" class="form-control" data-validation="required">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orgName" id="orgName" class="form-control" placeholder="Organization Name" value="<?php echo $orgName; ?>" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Organization Mobile</label>
                                    <input type="text" name="orgMobile" id="orgMobile" class="form-control" placeholder="Organization Mobile" value="<?php echo $orgMobile; ?>" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" value="<?php echo $orgAddress; ?>" placeholder="Organization Address" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Organization Establish Date</label>
                                    <input type="date" name="establishdate" value="<?php echo $orgEstablished; ?>" max="<?php echo date('Y-m-d'); ?>" id="establishdate" placeholder="Organization Establish Date" class="form-control">
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo form_open("university/requestFacility", ["id" => "facility_form"]); ?>
                                <input type="hidden" name="id" id="id" value="no_one">
                                <fieldset>
                                    <!-- Text input-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo form_open('university/addNewOrganisationType', ["id" => "organizationTypeForm"]); ?>
                        <fieldset>
                            <!-- Text input-->
...
<script type="text/javascript">
    ...
    function facilities_div() {
        $.ajax({
            url: '<?php echo site_url('university/orgFacilities'); ?>',
