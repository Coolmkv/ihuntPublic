...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Institute Controls</li>
        </ol>
    </section>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Institute Controls</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="showdata_table" class="table table-bordered table-striped table-responsive table-condensed">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th><th>Institute Name</th>
                                            <th>Profile Status</th><th>Contact Details</th>
                                            <th>Institute Address</th><th>Web site Link</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("change", ".weblink", function () {
            ...
            $.ajax({
                type: "POST",
                data: {id: id, weblink: weblink, roletype: "Institute", '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'},
...
<script type="text/javascript">
    $(".instituteControls_link").addClass("active");
    $(".organicationControls_link").addClass("active");
    document.title = "iHuntBest | Institute Controls";
</script>
