        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('school/addPromocode', ["id" => "form_details"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-md-12">
                                <label>Course</label>
                                <select name="sClassId" id="sClassId" class="form-control" data-validation="required"></select>
                            </div>
                            <div class="form-group col-md-4 col-md-12">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        getCourseName('', 'sClassId');
        function getCourseName(selval, Position) {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('school/getCourseNames'); ?>",
                success: function (response) {
                    var json = $.parseJSON(response);
                    var seldata = '<option value="">Select</option>';
                    for (var i = 0; i < json.length; i++) {
                        seldata = seldata + '<option value="' + json[i].sClassId + '">' + json[i].courseName + '</option>';
                    }
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "promocodeDetailsId=" + promocodeDetailsId,
                            url: "<?php echo site_url("school/delPromocode"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
