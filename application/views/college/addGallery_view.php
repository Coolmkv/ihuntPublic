...
<?php echo form_open_multipart('college/addNewGalleryImage', ["id" => "galary_form", "role" => "form", "name" => "galary_form", "data-toggle" => "validator"]); ?>
                                    <fieldset>
                                        <div>
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-white btn-file">
                                                            ...
                                                            <input type="file" id="galaryUrl" accept="image/*" name="galaryUrl" class="default" onchange="readURL(this);"/>
                                                        </span>
                                                        <b>(1024 * 500)</b>
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: '<?php echo site_url('college/deleteGalleryImage'); ?>',
