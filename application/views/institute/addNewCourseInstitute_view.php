		...
		<div class="row box-body">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<?php echo form_open('Institute/addUpdateNewCourse', ["name" => "course_form", "id" => "new_course_form"]); ?>
						<div class="row">
							<input type="hidden" name="id" id="id" value="">
							<div class="col-md-6 col-md-offset-3">
								<div class="form-group">
									<label>Select Course</label>
									<select name="course_masters_id[]" data-live-search="true" required id="course_masters_id" class="form-control selectpicker" multiple data-validation="required">
									<?php
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('Institute/editCourseMaster', ["name" => "editCourse", "id" => "editCourse_form"]); ?>
                        <fieldset>
...
<script type="text/javascript">
	...
	let datatable =	$('#page_table').DataTable({
        ...
        serverSide: false,
        ajax: {
			'url':'<?php echo site_url('Institute/getAllCourseDetails'); ?>',
			'method':'post'
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url("Institute/deleteCourseMasterEntry"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
