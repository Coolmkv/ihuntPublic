        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("institute/addEvent", ["id" => "event_form", "name" => "event_form"]); ?>
                    <div class="box-body">
                        <div class="row">
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '.editevent', function () {
                ...
                $.ajax({
                    type: "POST",
                    data: "ed=" + eventId,
                    url: "<?php echo site_url('institute/getEvents'); ?>",
                    ...
                    buttons: {
                        ...
                        Confirm: function () {
                            $.ajax({
                                type: "POST",
                                data: "del=" + eventId,
                                url: "<?php echo site_url('institute/delEvent'); ?>",
                                success: function (response) {
                                    var json = $.parseJSON(response);
