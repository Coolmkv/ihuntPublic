        ...
        <div class="row">
            <div class="row box-body">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart('institute/uploadApprovalDocs', ["id" => "form_Submit", "name" => "form_Submit"]); ?>
            ...
            <script>
                ...
                function editme(id) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('institute/uploadedDocument'); ?>",
                        data: {id: id},
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json) {
                        ...
                        buttons: {
                            ...
                            Confirm: function () {
                                $.ajax({
                                    type: "POST",
                                    data: "del=" + id,
                                    url: "<?php echo site_url("institute/deletedocument"); ?>",
                                    success: function (response) {
                                        var json = $.parseJSON(response);
                                        if (json.status === 'success') {
