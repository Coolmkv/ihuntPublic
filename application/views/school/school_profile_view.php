            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart("school/uploadProfileImage", ["name" => "logo_form", "class" => "form-horizontal", "id" => "logo_form"]) ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('school/uploadHeaderImage', ["name" => "header_form"]); ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <br><br><br><br>
                                <a href="<?php echo site_url('school/editprofile'); ?>"><button style="margin-top:3px;width: 135px" class="form-control btn btn-primary" type="submit" name="header_submit" id="header_submit">Edit Profile</button></a>
                            </div>
