...
<?php echo form_open_multipart('school/addFaculty', ["id" => "faculty_form", "name" => "faculty_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editFaculty", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + facultyId,
                url: "<?php echo site_url('school/getFaculty'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("school/delFaculty"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
