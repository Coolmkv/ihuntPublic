...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url('college'); ?>"><i class="fa fa-dashboard"></i>Dashboard</a></li>
    ...
    <section class="content">
        <div class="row">
            <div class="row box-body">
                <div class="col-md-12">
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <?php echo form_open_multipart('college/uploadApprovalDocs', ["id" => "form_Submit", "name" => "form_Submit"]); ?>
            ...
            <script>
                ...
                $(".view_approval_link").addClass("active");
                ...
                function editme(id) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('college/uploadedDocument'); ?>",
                        data: {id: id},
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json) {
                        ...
                        buttons: {
                            ...
                            Confirm: function () {
                                $.ajax({
                                    type: "POST",
                                    data: "del=" + id,
                                    url: "<?php echo site_url("college/deletedocument"); ?>",
                                    success: function (response) {
                                        var json = $.parseJSON(response);
                                        if (json.status === 'success') {
