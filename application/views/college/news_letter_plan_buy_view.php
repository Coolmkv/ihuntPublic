        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/addnewsletterplanbuy', ["id" => "nlpb_form", "name" => "nlpb_form"]); ?>
                    <div class="box-body">
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getPlanName() {
            $.ajax({
                url: "<?php echo site_url('college/getNewsLetterPlandetailsJson'); ?>",
                type: 'POST',
                data: '',
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('college/getnewsletterplanbuy'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
        ...
        $(document).on("change", ".Status", function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('College/changeStatusNlpb'); ?>",
                success: function (response) {
                    var json = $.parseJSON(response);
                    if (json.status === 'success') {
                        $.alert({title: 'Success!', content: json.msg, type: 'blue',
