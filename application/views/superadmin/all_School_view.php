                                ...
                                <table id="showdata_table" class="table table-bordered table-striped table-responsive">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Top Rated School</th>
                                            <th>Latest School</th>
                                            <th>Feature School</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("change", ".login_status", function () {
            ...
            $.ajax({
                type: "POST",
                data: "id=" + id + '&login_status=' + login_status + '&roletype=School',
        ...
        $(document).on('change', '.changeStatus', function () {
            ...
            $.ajax({
                type: "POST",
                data: {orgId: orgId, orgStatus: orgStatus, Statustype: Statustype, orgType: 'School', statusName: statusName},
        ...
        $(document).on('change', '.admin_approved', function () {
            ...
            $.ajax({
                type: "POST",
                data: "loginId=" + loginId + '&admin_approved=' + admin_approved + '&roleType=School',
...
<script type="text/javascript">
    $(".treeviewSd_link").addClass("active");
    $(".organicationDetails_link").addClass("active");
    document.title = "iHuntBest | School Details";
</script>