        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/addNews', ["id" => "news_form", "name" => "news_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="file" accept="image/x-png,image/gif,image/jpeg" name="newsImage" id="newsImage" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editNews", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + newsId,
                url: "<?php echo site_url('university/getNews'); ?>",
                success: function (response) {
                    ...
                    $('#publishDate').val(json[0].publishDate);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + newsId,
                            url: "<?php echo site_url("university/delNews"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
