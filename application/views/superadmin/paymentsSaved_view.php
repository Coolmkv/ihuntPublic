...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Payment Saved Text </li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title"> Payment Saved Text</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editPaymentsSaved", ["id" => "submit_form"]); ?>

                                <div class="form-group col-md-12">

                                    <input type="hidden" class="hidden" name="bybId" id="bybId" value="">

                                    <label>  Payment Saved Text </label>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="editPaymentsSaved();">Edit</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getPaymentsSaved'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.psText);

                    $("#bybId").val(json.psId);

                    $('#beforeYouBegin').summernote('code', json.psText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | ihunt Payment Saved";
