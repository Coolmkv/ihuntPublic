...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Page Request Details</li>
        </ol>
    </section>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Page Request Details</h3>
                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {pageStatusType: "approval_request"},
            ...
            success: function (response) {
                ...
                for (var i = 0; i < json.length; i++) {
                    if (json[i].approvalStatus === 'approval_request') {
                        var approvalReq = '<span class="btn btn-sm btn-primary">Requested For Approval</span>';
                    }
                    if (json[i].approvalStatus === 'approval_rejected') {
                        var approvalReq = '<span class="btn btn-sm btn-danger">Request Rejected</span>';
                    }
    ...
    function viewPage(pageId) {
        if (pageId !== "") {
            $.ajax({
                type: "POST",
                data: {pageId: pageId, pageStatusType: "approval_request"},
                url: "<?php echo site_url('superadmin/getPageRequests'); ?>",
                success: function (response) {
                    if (response !== "") {
                        var json = $.parseJSON(response);
...
<script type="text/javascript">
    ...
    $(".pageReqLink").addClass("active");
    document.title = "iHuntBest | Page Request Details";
</script>