        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/addBrochures', ["name" => "brouchers_form", "id" => "brouchers_form"]); ?>
                    <div class="box-body">
                        <div class="row">
...
<?php if (isset($_GET['ed'])) { ?>
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + broucherId,
                url: "<?php echo site_url('university/brochuresTable'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + broucherId,
                            url: "<?php echo site_url('university/delBrochures'); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
