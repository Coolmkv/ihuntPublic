        ...
        <div class="row box-body">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("institute/editTestimonials", ["id" => "submit_form"]); ?>
                    <div class="box-body">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editfunction", function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('institute/getTestimonials'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo site_url('institute/delTestimonial'); ?>",
                            success: function (response) {
                                var result = $.parseJSON(response);
