        ...
        <div class="row box-body">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/addNewPages', ["id" => "pages_form", "name" => "pages_form"]); ?>
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editPages', function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('University/showPages'); ?>",
                ...
                success: function (response) {
                    ...
                    //$("#description").summernote({focus: true,code:});
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        ...
                        $.ajax({
                            ...
                            url: "<?php echo site_url("university/delPages"); ?>",
            ...
            success: function (response) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    oTable.fnAddData([
                        ...
                        '<a href="javascript:" class="editPages editbtn" ed="' + json[i].pageId + '" title="Edit"><button class="btn btn-sm btn-primary">view/edit page</button></a>',

                        '<a href="javascript:" del="' + json[i].pageId + '" class="deletePages" title="Delete"><i class="fa fa-trash-o"></i></a>\n\
            ...
            buttons: {
                ...
                Confirm: function () {
                    ...
                    $.ajax({
                        ...
                        url: "<?php echo site_url("university/submitForApproval"); ?>",
