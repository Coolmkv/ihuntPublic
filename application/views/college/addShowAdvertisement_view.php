        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart('college/addAdvertisement', ["id" => "advertisement_form", "name" => "advertisement_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                ...
                <div class="container-fluid nopadding">
                    <div class="row"  >
                        <div class="col-lg-12 nopadding">
                            <?php echo form_open('college/updateTime', ["id" => "startDate_form", "name" => "startDate_form"]); ?>
                            <fieldset>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".editAdvertisement", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + adsId,
                url: "<?php echo site_url('college/getAdvertisement'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("college/delAdvertisement"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
    ...
    function getLocations() {
        $.ajax({
            url: "<?php echo site_url('college/getPlandetailsJson'); ?>",
            type: 'POST',
            data: {location: "find"},
            success: function (response) {
                var json = $.parseJSON(response);
