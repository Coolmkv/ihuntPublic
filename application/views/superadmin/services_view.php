...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Services Text</li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Services Text</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editServices", ["id" => "submit_form"]); ?>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="editServices();">Edit</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getServices'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.srvcText);

                    $("#bybId").val(json.srvcId);

                    $('#beforeYouBegin').summernote('code', json.srvcText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | Our Services";
