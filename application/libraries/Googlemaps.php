...
class Googlemaps {
	...
	var $apiKey				= 'AIzaSyACimPVNI1GUVZIfy5HA342kjuq7grLzS0'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
			  	...
			  	directionsService.route(request, function(response, status) {
			    	if (status == google.maps.DirectionsStatus.OK) {
			    		...
			    		switch (status) {
			    			...
			    			case "ZERO_RESULTS": { $("#directionsDiv").text("No route could be found between the start location and destination"); break }
    ...
    function get_lat_long_from_address($address, $attempts = 0) {
        ...
        $data_location .= "maps.google.com/maps/api/geocode/json?address=" . urlencode(utf8_encode($address)) . "&key=" . $this->apiKey . "&sensor=" . $this->sensor;
