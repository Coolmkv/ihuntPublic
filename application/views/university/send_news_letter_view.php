        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?php echo form_open_multipart('university/uploadnewsltremailexcel', ["id" => "form_upload", "name" => "form_upload"]); ?>
                        <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/emailnewsletter', ["id" => "sendnl_form", "name" => "sendnl_form"]); ?>
                    <div class="box-body">
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getEmail() {
            $.ajax({
                url: "<?php echo site_url('University/getnewsletteremailJson'); ?>",
                type: 'POST',
                data: '',
