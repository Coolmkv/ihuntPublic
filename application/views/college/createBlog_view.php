...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            <li><a href="<?php echo site_url("college/dashboard"); ?>"><i class="fa fa-dashboard"></i> College Dashboard</a></li>
        ...
        <div class="row box-body">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("college/insertBlogs", ["id" => "submit_form"]); ?>
                    <div class="box-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('college/getBlogCategories'); ?>",
            success: function (response) {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('college/getBlogsDetails'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url('college/delBlog'); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
                                if (json.status === 'success') {
                                    $.alert({title: 'Success!', content: json.msg, type: 'blue',
