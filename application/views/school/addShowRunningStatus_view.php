        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('school/addRunningStatus', ["id" => "running_form", "name" => "running_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editRunningStatus', function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('school/getRunningStatus'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + pageId,
                            url: "<?php echo site_url("school/delRunningStatus"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
                                ...
                                $.alert({
                                    title: 'Error!', content: jqXHR + " " + exception, type: 'red',
                                    typeAnimated: true,
                                    buttons: {
                                        Ok: function () {
                                            window.location.reload();
