...
<div class="content-wrapper">
    ...
    Return Policy Text
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Return Policy Text</li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title"> Return Policy Text</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editReturnPolicy", ["id" => "submit_form"]); ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getReturnPolicy'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.rpText);

                    $("#bybId").val(json.rpId);

                    $('#beforeYouBegin').summernote('code', json.rpText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | Return Policy";
