        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart('institute/addPlacedStudent', ["id" => "placement_form", "name" => "placement_form"]); ?>
                    <div class="box-body">
                        <div class="row">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < json.length; i++) {
                    coursedetails[json[i].insCourseDetailsId] = json[i].courseName + '(' + json[i].courseDurationType + ', ' + json[i].timeduration + ')';
                    data = data + '<option value="' + json[i].insCourseDetailsId + '">' + json[i].courseName + '(' + json[i].courseDurationType + ', ' + json[i].timeduration + ')</option>';
                }
                $('#' + position).html(data);
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editPlacement", function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('institute/placedStudentRecords'); ?>",
                success: function (response) {
                    var json = $.parseJSON(response);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "placedstudentId=" + placedstudentId,
                            url: "<?php echo site_url("institute/delPlacedStudent"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
