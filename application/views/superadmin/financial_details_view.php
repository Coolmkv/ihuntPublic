        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        <?php echo form_open('superadmin/saveFinancialDetails', ['id' => 'form_details', 'name' => 'form_details']); ?>
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" maxlength="20" name="micr_code" id="micr_code" value="<?php echo $micr_code; ?>" placeholder="MICR Code" class="form-control">
                                </div>
                            </div>
                            <!--                            <div class="col-md-4">
                                                            <div class="form-group">
