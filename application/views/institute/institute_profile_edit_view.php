        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('institute/updateProfile', ["id" => "profile_form", "name" => "profile_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="directorName" id="directorName" value="<?php echo $directorName; ?>" class="form-control" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Director Mobile</label>
                                    <input type="text" name="directorMobile" id="directorMobile" value="<?php echo $directorMobile; ?>" class="form-control" data-validation="number length required"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" name="directorEmail" id="directorEmail" value="<?php echo $directorEmail; ?>"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orgName" id="orgName" class="form-control"
                                           value="<?php echo $orgName; ?>" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Organization Mobile</label>
                                    <input type="text" name="orgMobile" id="orgMobile" class="form-control"
                                           value="<?php echo $orgMobile; ?>" data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orgEmail" id="orgEmail" class="form-control"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orgGoogle" id="orgGoogle" class="form-control" value='<?php echo $orgGoogle; ?>'>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="orgWebsite" id="orgWebsite" class="form-control" value="<?php echo $orgWebsite; ?>"
                                           data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="approvedBy" id="approvedBy" class="form-control" value="<?php echo $approvedBy; ?>"
                                           data-validation="required">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address" id="address" class="form-control" data-validation="required" value="<?php echo $orgAddress; ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Organization Establish Date</label>
                                    <input type="date" name="orgEstablished" value="<?php echo ($orgEstablished != "0000-00-00" ? $orgEstablished : ""); ?>" max="<?php echo date('Y-m-d'); ?>" id="establishdate" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Description</label>
                                <textarea name="orgDesp" id="orgDesp" class="form-control summernote"
                                          data-validation="required"></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Our Mission</label>
                                <textarea name="orgMission" id="orgMission" class="form-control summernote"
                                          data-validation="required"></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <label>Our Vision</label>
                                <textarea name="orgVission" id="orgVission" class="form-control summernote"
                                          data-validation="required"></textarea>
                            </div>
                            <div class="form-group" >
                                <div class="">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <?php echo form_open("institute/requestFacility", ["id" => "facility_form"]); ?>
                                <input type="hidden" name="id" id="id" value="no_one">
                                <fieldset>
                                    <!-- Text input-->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <?php echo form_open('institute/addNewOrganisationType', ["id" => "organizationTypeForm"]); ?>
                        <fieldset>
                            <!-- Text input-->
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('.summernote').summernote({ignore: ':hidden:not(.summernote),.note-editable.card-block'});

        $.ajax({
            url: "<?php echo site_url("institute/getProfileData"); ?>",
            type: 'POST',
            data: '',
            success: function (response) {
                if (response) {
    ...
    function facilities_div() {
        $.ajax({
            url: '<?php echo site_url('institute/orgFacilities'); ?>',
