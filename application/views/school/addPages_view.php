        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('school/addNewPages', ["id" => "pages_form", "name" => "pages_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editPages', function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + pageId,
                url: "<?php echo site_url('school/showPages'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + pageId,
                            url: "<?php echo site_url("school/delPages"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
                            ...
                            error: function (jqXHR, exception) {
                                $.alert({
                                    title: 'Error!', content: jqXHR, type: 'red',
                                    typeAnimated: true,
                                    buttons: {
                                        Ok: function () {
                                            window.location.reload();
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: "<?php echo site_url("school/submitForApproval"); ?>",
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                $.alert({
