        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart('university/addAdvertisement', ["id" => "advertisement_form", "name" => "advertisement_form"]); ?>
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="adsTitle" id="adsTitle" class="form-control"
                            ...
                            <div class="form-group col-md-4">
                                <label>Price</label>
                                <input id="price"  name="price" class="form-control" disabled="">
                                </input>
                            </div>
                            <div class="form-group col-md-4">
                                <label>Days</label>
                                <input id="days" name="days"   class="form-control" disabled="">
                                </input>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                ...
                <div class="container-fluid nopadding">
                    <div class="row"  >
                        <div class="col-lg-12 nopadding">
                            <?php echo form_open('university/updateTime', ["id" => "startDate_form", "name" => "startDate_form"]); ?>
                            <fieldset>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $(document).on("click", ".editAdvertisement", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + adsId,
                url: "<?php echo site_url('university/getAdvertisement'); ?>",
                success: function (response) {
                    ...
                    $('#startDate').val(json[0].ad_start_date);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("university/delAdvertisement"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    } else if (json[i].apprv_by_admin === '2')
                    {
                        status = '<span class="label label-primary">Active</span>';
                        editbtn = '';
                        delbtn = '';
                    } else if (json[i].apprv_by_admin === '3') {
    ...
    function getLocations() {
        $.ajax({
            url: "<?php echo site_url('university/getPlandetailsJson'); ?>",
            type: 'POST',
            data: {location: "find"},
            success: function (response) {
                var json = $.parseJSON(response);
    ...
    function getPlansForimageLoc(img_loc, selplanId) {
        $.ajax({
            ...
            success: function (response) {
                if (response !== "") {
                    var json = $.parseJSON(response);
                    var data = '<option value="">Select Plan</option>';
                    for (var i = 0; i < json.length; i++) {
                        data = data + '<option value="' + json[i].planId + '"> ' + json[i].plan_name + '</option>';
                    }
