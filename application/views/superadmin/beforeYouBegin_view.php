            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">Before You Begin Text</h3>
                    </div>

                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12 hidden" id="insertBYB">
                                <?php echo form_open("superadmin/editInsetBeforeYouBegin", ["id" => "submit_form"]); ?>
                                <div class="form-group col-md-12">
                                    <input type="hidden" class="hidden" name="bybId" id="bybId" value="">
                                    <label>Before You Begin Text</label>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    <button type="button" class="btn btn-info" onclick="editBeforeYouBegin();">Edit</button>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('superadmin/getBeforeYouBegin'); ?>",
            success: function (response) {
                if (response !== "") {
                    var json = $.parseJSON(response);
                    $("#BYBText").html(json.bybText);
                    $("#bybId").val(json.bybId);
                    $('#beforeYouBegin').summernote('code', json.bybText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | Before You Begin";
</script>