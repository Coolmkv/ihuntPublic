                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url('college/delStreams') ?>",
            ...
            success: function (response) {
                ...
                for (var i = 0; i < json.length; i++) {
                    oTable.fnAddData([
                        ...
                        json[i].feeDetails,
                        '<a href="addStreams?orgStreamId=' + json[i].orgStreamId + '&desp=desp"><button  type="button" class="btn btn-primary desp">Show Description</button></a>',
                        '<a href="addStreams?orgStreamId=' + json[i].orgStreamId + '"><button class="btn btn-primary btn-sm btn-flat editAction"><i class="fa fa-edit"></i></button></a>',
