        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('university/addPromocode', ["id" => "form_details"]); ?>
                    <div class="box-body">
                        <div class="row">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getCourseName(selval, Position) {
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('university/getCourseNames'); ?>",
        ...
        $(document).on("click", ".editDetails", function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('university/getPromocode'); ?>",
                success: function (response) {
                    var json = $.parseJSON(response);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "promocodeDetailsId=" + promocodeDetailsId,
                            url: "<?php echo site_url("university/delPromocode"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
