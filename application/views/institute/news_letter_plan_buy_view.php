        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('institute/addnewsletterplanbuy', ["id" => "nlpb_form", "name" => "nlpb_form"]); ?>
                    <div class="box-body">
                        <div class="row">
...
<!-- Control Sidebar -->
<!-- ./wrapper -->
<?php include 'institute_footer.php' ?>
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function getPlanName() {
            $.ajax({
                url: "<?php echo site_url('institute/getNewsLetterPlandetailsJson'); ?>",
                type: 'POST',
                data: '',
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('institute/getnewsletterplanbuy'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
        ...
        $(document).on("change", ".Status", function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('institute/changeStatusNlpb'); ?>",
                success: function (response) {
                    var json = $.parseJSON(response);
                    if (json.status === 'success') {
                        $.alert({title: 'Success!', content: json.msg, type: 'blue',
