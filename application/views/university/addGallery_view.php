                        ...
                        <div class="my-panel-body">
                            <div class="list-unstyled row clearfix masonry-container lightgallery"
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 item video">
                                    ...
                                    <?php echo form_open_multipart('university/addNewGalleryImage', ["id" => "galary_form", "role" => "form", "name" => "galary_form", "data-toggle" => "validator"]); ?>
                                    <fieldset>
                                        <div>
                                                ...
                                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                                    ...
                                                    <div>
                                                        <span class="btn btn-white btn-file">
                                                            ...
                                                            <input type="file" accept="image/x-png,image/gif,image/jpeg" id="galaryUrl"
            ...
            $.confirm({
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: {id: galaryId, imgPath: imgPath, ihuntcsrfToken: '<?php echo get_cookie('ihuntcsrfCookie'); ?>'},
                            url: '<?php echo site_url('University/deleteGalleryImage'); ?>',
