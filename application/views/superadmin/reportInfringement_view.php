...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Report Infringement Text</li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">Report Infringement Text</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editReportInfringement", ["id" => "submit_form"]); ?>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="editReportInfringement();">Edit</button>
...
<script type="text/javascript">
    ...
    function editReportInfringement() {
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getReportInfringement'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.riText);

                    $("#bybId").val(json.riId);

                    $('#beforeYouBegin').summernote('code', json.riText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | Report Infringement";
