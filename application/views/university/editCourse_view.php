    ...
    <script type="text/javascript">
        ...
        function addPreRequisite(minQualificationset, percentage, markingTypes) {
            ...
            $("#course_prerequistesdiv").append('<div class="divadded" id="divremove' + count + '"> ' +
					...
					'</div> iv class="col-md-2 col- col-sm-12col-md-offset-2">' +
					'<select name="condition[]" class="form-control" id="relation' + count + '" ' +
					...
					'<div class="form-group">' +
					'<label for="Title">Marking Type</label>' +
					'<select name="markingType[]" id="markingType' + count + '" class="form-control markingType"' +
					' data-validation="required">' + mType + '</select>' +
					'</div>' +
					'</div>' +
					'<div class="col-md-6 col-sm-12">' +
					'<div class="form-group">' +
					...
					'</div>' +
					'</div>' +
					'<div class="col-md-1 col-sm-12"><br>' +
					'<a href="javascript:" onclick="removediv(\'divremove' + count + '\');" ' +
					'class="remove_field fa fa-remove btn btn-danger"></a>' +
