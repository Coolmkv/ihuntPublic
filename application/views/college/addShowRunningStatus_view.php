        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/addRunningStatus', ["id" => "running_form", "name" => "running_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.editRunningStatus', function () {
            ...
            $.ajax({
                ...
                url: "<?php echo site_url('college/getRunningStatus'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + pageId,
                            url: "<?php echo site_url("college/delRunningStatus"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
