        ...
        <div class="row box-body">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("institute/insertBlogs", ["id" => "submit_form"]); ?>
                    <div class="box-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('institute/getBlogCategories'); ?>",
            success: function (response) {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('institute/getBlogsDetails'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url('institute/delBlog'); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
                                if (json.status === 'success') {
                                    $.alert({title: 'Success!', content: json.msg, type: 'blue',
