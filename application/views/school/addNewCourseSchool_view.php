...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"> Add|Show Classes</li>
        </ol>
    </section>
    <!-- Main content -->
		...
		<div class="row box-body">
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-body">
						<?php echo form_open('school/addUpdateNewCourse', ["name" => "course_form", "id" => "new_course_form"]); ?>
						<div class="row">
							<input type="hidden" name="id" id="id" value="">
							<div class="col-md-6 col-md-offset-3">
								<div class="form-group">
									<label>Select Classes</label>
									<select name="course_masters_id[]" required id="course_masters_id" class="form-control selectpicker" data-live-search="true" multiple data-validation="required">
									<?php
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php echo form_open('school/editCourseMaster', ["name" => "editCourse", "id" => "editCourse_form"]); ?>
                        <fieldset>
...
<script type="text/javascript">
	...
	let datatable =	$('#page_table').DataTable({
        ...
        serverSide: false,
        ajax: {
			'url':'<?php echo site_url('school/getAllCourseDetails'); ?>',
			'method':'post'
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url("school/deleteCourseMasterEntry"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
