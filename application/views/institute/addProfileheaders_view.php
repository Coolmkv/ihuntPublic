            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header modal-header-primary">
                        ...
                        <h3><i class="fa fa-image m-r-5"></i>Upload New Header Image</h3>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart("institute/uploadheaderImageVideo", ["name" => "imageForm", "class" => "form-horizontal", "id" => "imageForm"]) ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('institute/uploadheaderImageVideo', ["name" => "header_video", "id" => "header_video"]); ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                                        <label >Upload Header Video:</label>
                                        <input type="file" accept="video/mp4,video/x-m4v,video/*" name="orgvideoHeader" id="orgvideoHeader"  class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <button style="margin-left:5px; margin-top: 5px;width: 100px" class="form-control btn btn-primary" type="submit" onclick="clearForm('imageVideo');" id="orgLogo" name="orgLogo" data-toggle="modal" data-target="#UploadImage">Upload Image</button>
                                    </div>
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group videodiv">
                                    ...
                                    <div class="text-center">
                                        <button style="margin-left:5px; margin-top: 5px;width: 100px" class="form-control btn btn-primary" type="submit" id="orgLogo" onclick="clearForm('header_video');"  name="orgLogo" data-toggle="modal" data-target="#HeaderVideo">Edit Video</button>
                                    </div>
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('institute/deleteHeaderImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('institute/setDefaultImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
