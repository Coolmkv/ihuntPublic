            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart("college/uploadheaderImageVideo", ["name" => "imageForm", "class" => "form-horizontal", "id" => "imageForm"]) ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <?php echo form_open_multipart('college/uploadheaderImageVideo', ["name" => "header_video", "id" => "header_video"]); ?>
<!--                                        <input type="hidden" name="id" id="id" value="no_one">-->
                                <fieldset>
                                    <!-- Text input-->
                                    <div class="col-md-6 form-group">
                                        <label >Upload Header Video:</label>
                                        <input type="file" accept="video/mp4,video/x-m4v,video/*,video/mkv,video/m1v,.mkv" name="orgvideoHeader" id="orgvideoHeader"  class="form-control">
                                        ...
                                        <input type="hidden" name="headerVideoUrl" class="hidden" value="<?php echo $orgVideo ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group">
                                    ...
                                    <div class="text-center">
                                        <button style="margin-left:5px; margin-top: 5px;width: 100px" class="form-control btn btn-primary" type="submit" id="orgLogo" name="orgLogo" onclick="clearForm('imageVideo');" data-toggle="modal" data-target="#UploadImage">Upload Image</button>
                                    </div>
                            ...
                            <div class="col-md-6 text-center">
                                <div class="form-group videodiv">
                                    ...
                                    <div class="text-center">
                                        <button style="margin-left:5px; margin-top: 5px;width: 100px" class="form-control btn btn-primary" type="submit" id="orgLogo" name="orgLogo" data-toggle="modal"  onclick="clearForm('header_video');"  data-target="#HeaderVideo">Edit Video</button>
                                    </div>
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('college/deleteHeaderImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
            ...
            buttons: {
                ...
                Confirm: function () {
                    $.ajax({
                        ...
                        url: '<?php echo site_url('college/setDefaultImage'); ?>',
                        success: function (response) {
                            var json = $.parseJSON(response);
                            if (json.status === 'success') {
                                var json = $.parseJSON(response);
