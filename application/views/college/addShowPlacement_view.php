        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('college/addPlacement', ["id" => "placement_form", "name" => "placement_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editPlacement", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + placementId,
                url: "<?php echo site_url('college/getPlacement'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url("college/delPlacement"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
