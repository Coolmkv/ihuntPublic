        ...
        <div class="row box-body">
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <?php echo form_open('school/addConcernedPersonDetails', ["name" => "concernedPersonDetails_form", "id" => "concernedPersonDetails_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editfunction", function () {
            ...
            $.ajax({
                type: "POST",
                data: {cp_Id: cp_Id},
                url: "<?php echo site_url('school/getConcernedPersonDetails'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url('school/delConcernedPerson'); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
