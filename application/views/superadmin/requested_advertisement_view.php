    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Requested Advertisement Details</li>
            </ol>
        </section>
                ...
                <div class="col-md-12 table-responsive"> 
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Requested Advertisement Details</h3>
                        </div>

                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <table id="requestadv_table" class="table table-bordered table-striped table-responsive">
                                        <thead>
                                        <tr>
                                            <th>Sr. No.</th>
                                            <th>Adv Banner</th>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('Superadmin/getAdvertisement');?>",
            success: function (response) {
                var json = $.parseJSON(response);
                var oTable = $('table#requestadv_table').dataTable();
                var status  =   "";
                oTable.fnClearTable();
                for (var i = 0; i < json.length; i++) {
                    if (json[i].adsBanner === '') {
                        var image_url = '';
                         ...
                         image_url = base_url + json[i].adsBanner;
                    }
                    ...
                    if (json[i].apprv_by_admin === '3') {
                         status = '<span class="label label-primary">UnApproved</span>';
                    }
                    ...
                    oTable.fnAddData([
                        ...
                        json[i].statename,
                        json[i].startdate,
                        '<select class="apprv_by_admin" adsId="' + json[i].adsId + '" style="background-color:#acd6e9;"><option value="">Choose One...</option><option value="2">Approve</option><option value="3">Unapprove</option>' + json[i].apprv_by_admin + '</select>',
                        status
                    ]);
                }
            }
...
<script type="text/javascript">
    ...
    $(".Req_adv_plan_link").addClass("active");
