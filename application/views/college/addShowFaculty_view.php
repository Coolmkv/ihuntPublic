...
<?php echo form_open_multipart('college/addFaculty', ["id" => "faculty_form", "name" => "faculty_form"]); ?>
                    <div class="box-body">
                        <div class="row">
    ...
    $(document).ready(function () {
        ...
        $(document).on("click", ".editFaculty", function () {
            ...
            $.ajax({
                type: "POST",
                data: "ed=" + facultyId,
                url: "<?php echo site_url('college/getFaculty'); ?>",
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            type: "POST",
                            data: "del=" + facultyId,
                            url: "<?php echo site_url("college/delFaculty"); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
