...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">School Controls</li>
        </ol>
    </section>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">School Controls</h3>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <table id="showdata_table" class="table table-bordered table-striped table-responsive">
                                    <thead>
                                        <tr>
                                            <th>Sr. No.</th><th>School Name</th>
                                            <th>Profile Status</th><th>Contact Details</th>
                                            <th>School Address</th><th>Web site Link</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on("change", ".weblink", function () {
            ...
            $.ajax({
                type: "POST",
                data: {id: id, weblink: weblink, roletype: "School", '<?php echo $this->security->get_csrf_token_name(); ?>': '<?php echo $this->security->get_csrf_hash(); ?>'},
        ...
        $(document).on('change', '.btnenquiryenroll', function () {
            ...
            if (btntype !== "") {
                $.ajax({
                    type: "POST",
                    data: "loginId=" + loginId + '&btntype=' + btntype + '&roleType=School',
        ...
        $.ajax({
            type: "POST",
            data: "",
            url: "<?php echo site_url('superadmin/getSchoolDetails'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
                var webLink = "";
                var enqenroll = "";
                ...
                for (var i = 0; i < json.length; i++) {
                    ...
                    oTable.fnAddData([
                        ...
                        'Ph. No: ' + json[i].orgMobile + '<br>Email: ' + json[i].email, json[i].orgAddress, webLink, enqenroll,
...
<script type="text/javascript">
    $(".schoolControls_link").addClass("active");
    $(".organicationControls_link").addClass("active");
    document.title = "iHuntBest | School Controls";
</script>
