        ...
        <div class="row box-body">
            <div class="col-md-12">
                <div class="box box-primary">
                    ...
                    <?php echo form_open_multipart("university/insertBlogs", ["id" => "submit_form"]); ?>
                    <div class="box-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('University/getBlogCategories'); ?>",
            success: function (response) {
        ...
        $.ajax({
            type: "POST",
            data: {},
            url: "<?php echo site_url('university/getBlogsDetails'); ?>",
            success: function (response) {
                var json = $.parseJSON(response);
                ...
                buttons: {
                    ...
                    Confirm: function () {
                        $.ajax({
                            ...
                            url: "<?php echo site_url('university/delBlog'); ?>",
                            success: function (response) {
                                var json = $.parseJSON(response);
                                if (json.status === 'success') {
                                    $.alert({title: 'Success!', content: json.msg, type: 'blue',
