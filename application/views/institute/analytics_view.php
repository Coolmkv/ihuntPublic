                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="info-box">
                                    ...
                                    <div class="info-box-content">
                                        ...
                                        <span class="info-box-number"><?php if (isset($visits)) {
    echo $visits->admissioninprocess;
} ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12">
                                <div class="info-box">
                                    <span class="info-box-icon bg-red-gradient"><i class="fa fa-bar-chart"></i></span>
                                    <div class="info-box-content">
                                        <span class="info-box-text">Admission rejected</span>
                                        <span class="info-box-number"><?php if (isset($visits)) {
    echo $visits->admissionrejected;
} ?></span>
                                    </div>
                                </div>
                            </div>
