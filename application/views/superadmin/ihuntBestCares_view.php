...
<div class="content-wrapper">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">ihunt Best care Text</li>
            ...
            <div class="col-md-12 table-responsive">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">ihunt Best care Text</h3>
                    ...
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 hidden" id="insertBYB">
                                ...
                                <?php echo form_open("superadmin/editIhuntBestCares", ["id" => "submit_form"]); ?>

                                <div class="form-group col-md-12">

                                    <input type="hidden" class="hidden" name="bybId" id="bybId" value="">

                                    <label>ihunt Best care Text</label>
                            ...
                            <div class="col-md-12 hidden" id="showBYB">
                                ...
                                <div class="col-md-12 text-center">
                                    ...
                                    <button type="button" class="btn btn-info" onclick="editIhuntBestCares();">Edit</button>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            ...
            url: "<?php echo site_url('superadmin/getIhuntBestCares'); ?>",
            ...
            success: function (response) {
                ...
                if (response !== "") {
                    ...
                    $("#BYBText").html(json.ibcText);

                    $("#bybId").val(json.ibcId);

                    $('#beforeYouBegin').summernote('code', json.ibcText);
...
<script type="text/javascript">
    ...
    document.title = "iHuntBest | ihunt Best Care";
