(function ($) {
    $.fn.multislider = function (data, callback) {
        ...
        ;var $imgLast, currentMargin, percentageRemaining, totalWidth, numberVisibleSlides, numberTotalSlides,
            animateDistance, animateSlideRight, animateSlideLeft, defaults, settings, animateDuration,
            autoSlideInterval;
        ...
        function allRight() {
            isItAnimating(function () {
                ...
                reTargetSlides();
                $imgFirst.animate({marginLeft: 0}, {
                    duration: animateDuration, easing: "swing", complete: function () {
        ...
        function singleLeft() {
            isItAnimating(function () {
                reTargetSlides();
                $imgFirst.animate({marginLeft: -animateDistance}, {
                    duration: animateDuration,
                    easing: "swing",
                    complete: function () {
